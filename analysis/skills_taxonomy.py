...
CATEGORY_HINTS: dict[str, list[str]] = {
    "Classical ML": ["random forest", "xgboost", "logistic regression", "scikit-learn", "gradient boosting"],
    "Deep learning": ["neural network", "pytorch", "tensorflow", "deep learning", "cnn", "lstm"],
    ...
    "Research assistant": ["research assistant", "principal investigator", "literature review", "lab"],
